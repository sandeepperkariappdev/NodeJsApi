...
var users = [
    {username:"sandep1", password:"testing"},
    {username:"sandep2", password:"testing"},
    {username:"sandep3", password:"testing"},
    {username:"sandep4", password:"testing"}
];
...
var createPosts = function(data){
    ...
    var newPosts = posts.map(function(){
       post.author = data.users[i]._id;
        return createDoc(Post, post);
    });
    
    return Promise.all(newPosts).then(function(savedPosts){
